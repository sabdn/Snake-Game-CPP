...
void Game::startGame(){
	...
	while(k != 27){
		...
		if(kbhit()){
			...
			// Следующий шаг движения основываясь на нажатой клавише
			head->x += x_inc;
			head->y += y_inc;

			// Не врезались ли в границы
...
int main(){
	// Инициализация игры по центру экрана вне зависимости от разрешения
